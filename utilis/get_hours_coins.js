...
async function newHoursAndCoins(data) {
  return new Promise((resolve, reject) => {
    ...
    const dataToSend = {
      ...
      eligible_hours: formatTime(eligibleHours, eligibleMinutes, eligibleSeconds),
      days,
    };
    resolve(dataToSend);
  });
...
function getNewTotal_salary(balance,data){
  return new Promise((resolve,reject)=>{
    ...
    if(balance<100000 ){
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((100000/temp)),35);
      ...
      data.extra_coin_bdt = Math.floor(basicPayPercentage(extra_coin,50)/temp);
      data.extra_coin_agency_bdt = Math.floor(basicPayPercentage(extra_coin,15)/temp);
      let agency_commision=basicPayPercentage(Math.floor((100000/temp)),9);
      data.agency_commision=agency_commision;
      data.host_total_bonus_salary=basic_pay_bdt + data.extra_coin_bdt + data.day_time_bonus_bdt;
      data.total_agency_commision=agency_commision+data.extra_coin_agency_bdt;
      data.total_salary=data.host_total_bonus_salary + data.total_agency_commision;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((200000/temp)),32);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((400000/temp)),33);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((800000/temp)),33);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((1200000/temp)),33);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((1800000/temp)),33);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((2500000/temp)),34);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((3500000/temp)),34);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }else{
      //   data.day_time_bonus=0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((4500000/temp)),34);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=5 && hours>=10){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((6500000/temp)),34);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((8500000/temp)),34);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }else{
      //   data.day_time_bonus = 0;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((11000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((14000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((18000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((23000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((28000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((50000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((100000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.extra_coin_bdt = Math.floor(basicPayPercentage(extra_coin,50)/temp);
      data.extra_coin_agency_bdt = Math.floor(basicPayPercentage(extra_coin,15)/temp);
      let agency_commision = basicPayPercentage(Math.floor((100000000/temp)),9);
      data.agency_commision = agency_commision;
      data.host_total_bonus_salary = basic_pay_bdt + data.extra_coin_bdt + data.day_time_bonus_bdt;
      data.total_agency_commision = agency_commision+data.extra_coin_agency_bdt;
      data.total_salary = data.host_total_bonus_salary + data.total_agency_commision;
      ...
      data.day_time_bonus_bdt=basicPayPercentage(Math.floor((150000000/temp)),35);
      // data.day_time_bonus_bdt = Math.floor((basic_pay_bdt/temp));
      // if(day>=4 && hours>=8){
      // }
      // else{
      ...
      data.extra_coin_bdt = Math.floor(basicPayPercentage(extra_coin,50)/temp);
      data.extra_coin_agency_bdt = Math.floor(basicPayPercentage(extra_coin,15)/temp);
      let agency_commision = basicPayPercentage(Math.floor((150000000/temp)),9);
      data.agency_commision = agency_commision;
      data.host_total_bonus_salary = basic_pay_bdt + data.extra_coin_bdt + data.day_time_bonus_bdt;
      data.total_agency_commision = agency_commision+data.extra_coin_agency_bdt;
      data.total_salary = data.host_total_bonus_salary + data.total_agency_commision;
...
module.exports={hoursAndCoins,startAndendDate,getTotal_salary,
  getNewTotal_salary,
  PrevstartAndendDate,newHoursAndCoins};